...
if(isset($_POST['search_key']))
{
    ...
    //instantiates the RecursiveKeyFinder Class
    $recursive_finder = new RecursiveKeyFinder();
    //instantiates the BinarySearch Class and passes the RecursiveKeyFinder Object to its constructor
    $binary_search = new BinarySearch($recursive_finder, $array_of_nos, $key);
    //gets the key
